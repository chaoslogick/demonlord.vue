  ...
  <div class="interior">
    <div class="wrap columns">
      ...
      <div class="sidebar">
        ...
        <a href="/assets/files/mpgResume2022.pdf" target="_blank">PDF</a> /
        <a href="/assets/files/mpgResume2022.json" target="_blank">JSON</a> /
        <a href="/assets/files/mpgResume2022.txt" target="_blank">TXT</a>
      </div>
    </div>
  </div>
</template>
